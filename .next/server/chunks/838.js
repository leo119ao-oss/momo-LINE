...
— 参考記事 —
${r}`}return"ごめん、いま手元のデータからは関連が拾えなかった… もう少し違う聞き方も試してみて？"}let u=c.map(e=>e.content).join("\n---\n");Array.from(new Set(c.map(e=>e.source_url)));let{lastUser:m,thread:p}=await y(e.id),g=`
${o}
